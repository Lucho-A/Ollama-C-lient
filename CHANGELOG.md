...
- in case of signal exception, stderr is written (except for 'Interactive' signals)
- enhanced resilience when wrong server messages are received.
#### bugs-fixed:
